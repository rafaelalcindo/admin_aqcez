...
<head>
    ...
    <script type="text/javascript" src="js/status_script/status_02.js" ></script>
    <script type="text/javascript" src="js/status_script/status_02_function.js"></script>
    ...
    <script type="text/javascript">
      ...
      function modalAddNovaEtapa(num){
        alert(num);

        $(document).ready(function(){

          $('#modalAddPassos').modal('show');
          $('#id_step').val(num);
...
<input type="hidden" id="id_step" value="" />
<div id="wrapper">
        ...
        <div class="container-fluid" style="margin-top: 3%;">
            ...
            <div class="row">
                <div class="col-lg-12">
                   ...
                   <!-- <button class="btn btn-primary btn-large" id="ad_orcamen" >Adicionar Orçamento.</button> -->
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary"  id="ad_orcamento" >Salvar</button>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="modal fade" id="modalAddPassos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <div class="row">
                  <div class="col-xs-6">
                    <div class="form-group">
                      ...
                      <label for="visu">Visualização</label>
                      <input type="text" class="form-control" id="visu" placeholder="Visualização" />
                  ...
                  <div class="col-xs-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" id="sele_nome">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
              <button type="button" class="btn btn-primary" id="add_fluxo">Salvar</button>
            </div>
          </div>
        </div>
      </div>
